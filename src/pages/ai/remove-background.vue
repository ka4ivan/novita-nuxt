...
const generateImages = async (val, action) => {
  ...
  try {
    ...
    const { data, error } = await $api().ai.removeBackground({
      body: payload,
    });
          ...
          <div class="ai__generate-instructions-wrapper">
            <div class="ai__generate-instructions-info">
              <h2 class="ai__generate-instructions-info__title">
                Як користуватися інструментом Novita для видалення фону
              </h2>
              <p class="ai__generate-instructions-info__text">
                Інструмент Novita для видалення фону — це рішення на базі штучного інтелекту, яке дозволяє користувачам легко видаляти фон з зображень. Це ідеальний інструмент для фотографій товарів, контенту для соціальних мереж та професійних дизайнерських проєктів. Слідуйте цьому посібнику, щоб дізнатися, як ефективно використовувати цей інструмент.
              </p>
            </div>
            ...
            <div class="ai__generate-instructions-step">
              ...
              <ul class="ai__generate-instructions-step-list">
                ...
                <li class="ai__generate-instructions-step-item">
                  Виберіть зображення з вашого пристрою, яке відповідає наступним вимогам:
                  <ul class="ai__generate-instructions-step-item-sublist">
                    <li class="ai__generate-instructions-step-item-sublist-item">
                      <span class="ai__generate-instructions-step-text-strong">Підтримувані формати:</span> JPG, PNG, WEBP.
                    </li>
                    <li class="ai__generate-instructions-step-item-sublist-item">
                      <span class="ai__generate-instructions-step-text-strong">Рекомендована роздільна здатність:</span> до 2048x2048 пікселів для оптимальних результатів.
                    </li>
                    <li class="ai__generate-instructions-step-item-sublist-item">
                      <span class="ai__generate-instructions-step-text-strong">Максимальний розмір файлу:</span> 30 МБ.
                    </li>
                  </ul>
                </li>
                <li class="ai__generate-instructions-step-item">
                  Після завантаження зображення воно відобразиться в панелі попереднього перегляду.
                </li>
              </ul>
              <p class="ai__generate-instructions-step-text">
                <span class="ai__generate-instructions-step-text-strong">Порада:</span> Використовуйте зображення високої якості з чітким контрастом між об'єктом і фоном для найкращих результатів.
              </p>
            </div>
            ...
            <div class="ai__generate-instructions-step">
              ...
              <ul class="ai__generate-instructions-step-list">
                <li class="ai__generate-instructions-step-item">
                  Після завантаження зображення ШІ автоматично виявить та видалить фон.
                </li>
                <li class="ai__generate-instructions-step-item">
                  Процес може зайняти кілька секунд залежно від складності зображення.
                </li>
                <li class="ai__generate-instructions-step-item">
                  Після обробки ви побачите зображення з прозорим фоном у панелі попереднього перегляду.
                </li>
              </ul>
            </div>
            ...
            <div class="ai__generate-instructions-step">
              <h3 class="ai__generate-instructions-step-title">
                Крок 3: Додаткові поради для кращих результатів
              </h3>
              <ul class="ai__generate-instructions-step-list">
                <li class="ai__generate-instructions-step-item">
                  <span class="ai__generate-instructions-step-text-strong">Використовуйте зображення з чітким фоном:</span> це допоможе ШІ точніше виявити та видалити фон.
                </li>
                <li class="ai__generate-instructions-step-item">
                  <span class="ai__generate-instructions-step-text-strong">Уникайте перевантажених або складних фонів:</span> це зменшить потребу в ручних доопрацюваннях.
                </li>
                <li class="ai__generate-instructions-step-item">
                  <span class="ai__generate-instructions-step-text-strong">Оберіть формат PNG:</span> коли вам потрібен прозорий фон для професійних дизайнерських цілей.
                </li>
              </ul>
            </div>
          </div>
